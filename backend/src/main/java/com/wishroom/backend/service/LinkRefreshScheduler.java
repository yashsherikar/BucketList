 ...
 * (e.g. the site was under maintenance, rate-limited us, or timed out).
 * Runs once a day at midnight IST so a temporary outage on a retailer's site
 * doesn't leave items permanently missing their image/title.
 */
@Service
